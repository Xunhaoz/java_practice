...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ArrayList<TruneyContainer> truneyContainerArray = new ArrayList<TruneyContainer>();
        ...
        for (String getUrl : getUrls) {
            ...
            truneyContainerArray.add(truneyContainer);
            driver.quit();
        }

        for (TruneyContainer truneyContainer : truneyContainerArray) {
